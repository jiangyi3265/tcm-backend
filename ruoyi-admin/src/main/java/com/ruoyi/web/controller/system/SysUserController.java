...
public class SysUserController extends BaseController
{
    ...
    public AjaxResult resetPwd(@RequestBody SysUser user)
    {
        ...
        if (rows > 0)
        {
            auditLogService.log("user", String.valueOf(user.getUserId()),
                    targetUser != null ? targetUser.getUserName() : String.valueOf(user.getUserId()),
                    "PASSWORD_RESET", String.valueOf(SecurityUtils.getUserId()), "管理员重置用户密码");
        }
        return toAjax(rows);
    }
